...
Text Domain: woocommerce-upcoming-products
...
class Woocommerce_Upcoming_Product
{
    ...
    {
        load_plugin_textdomain( 'woocommerce-upcoming-products', true, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    }
    ...
    {
        global $post;
        woocommerce_wp_checkbox( array('id'         => '_upcoming','label'      => __( 'Upcoming Product', 'woocommerce-upcoming-products' ),'description'=> __( 'Enable for upcoming product', 'woocommerce-upcoming-products' ) ) );
        $available_class = ( get_post_meta( $post->ID, '_upcoming', true ) == 'yes' ) ? '' : 'wup-hide';
        woocommerce_wp_text_input( array('id'           => '_available_on','label'        => __( 'Available On', 'woocommerce-upcoming-products' ),'wrapper_class'=> $available_class,'description'  => __( 'Insert product available date', 'woocommerce-upcoming-products' ) ) );
    }
    ...
    function save_upcoming_options( $post_id  )
    {
        ...
        $_available_on = ( isset( $_POST['_available_on'] ) ) ? $_POST['_available_on'] : __( 'Date not set', 'woocommerce-upcoming-products' );
    ...
    function upcoming_product_title( $title, $id )
    {
        ...
        $label     = WC_Admin_Settings::get_option( 'wup_title_label_txt', __( 'Upcoming', 'woocommerce-upcoming-products' ) );
    ...
    {
        $catalog_orderby['upcoming'] = __( 'Sort by upcoming', 'woocommerce-upcoming-products' );
    ...
    {
        $price_label = WC_Admin_Settings::get_option( 'wup_price_label_txt', __( 'Coming Soon', 'woocommerce-upcoming-products' ) );
            ...
            if ( $this->is_upcoming() ) {
                ...
                <div class="product_meta">
                    <span class="available-from">
                        <?php _e( 'Available from: ', 'woocommerce-upcoming-products' );

                        if ( $_available_on == '' ) {
                            ?>
                            <strong>
                                <?php _e( 'Date not yet set.', 'woocommerce-upcoming-products' ); ?>
                            </strong>
                            <?php
                        }else {
                            ?>
    ...
    {
        $sections['wup'] = __( 'Upcoming Products', 'woocommerce-upcoming-products' );
        return $sections;
    }
    ...
    function wup_wc_product_settings_option( $settings, $current_section )
    {
        if ( 'wup' == $current_section ) {
            $settings = apply_filters( 'wup_product_settings', array(
                    array(
                        'title'=> __( 'Upcoming Product', 'woocommerce-upcoming-products' ),
                        'type' => 'title',
                        'desc' => '',
                        'id'   => 'wup_options'
                    ),
                    ...
                    // array(
                    //     'title'  => __( 'Product auto live', 'woocommerce-upcoming-products' ),
                    //     'desc'   => __( 'Upcoming product will automatically go online on available date', 'woocommerce-upcoming-products' ),
                    //     'id'     => 'wup_auto_live',
                    //     'default'=> 'yes',
                    //     'type'   => 'checkbox'
                    // ),
                    ...
                    array(
                        'title'  => __( 'Upcoming Product title label', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Show label on upcoming product title', 'woocommerce-upcoming-products' ),
                        'id'     => 'wup_title_label',
                        'default'=> 'yes',
                        'type'   => 'checkbox'
                    ),
                    ...
                    array(
                        'title'  => __( 'Title label Text', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Label will show on upcoming product title', 'woocommerce-upcoming-products' ),
                    ...
                    array(
                        'title'  => __( 'Price Hide on Single Page', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Hide price of upcoming product on single product page', 'woocommerce-upcoming-products' ),
                    ...
                    array(
                        'title'   => __( 'Price Hide on Shop Page', 'woocommerce-upcoming-products' ),
                        'desc'    => __( 'Hide price of upcoming product on shop page', 'woocommerce-upcoming-products' ),
                    ...
                    array(
                        'title'  => __( 'Upcoming Product price label', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Show label under price of upcoming product', 'woocommerce-upcoming-products' ),
                        'id'     => 'wup_price_label',
                        'default'=> 'yes',
                        'type'   => 'checkbox'
                    ),
                    ...
                    array(
                        'title'  => __( 'Text Under Price', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Text under product price', 'woocommerce-upcoming-products' ),
                    ...
                    array(
                        'title'  => __( '"Add to Cart" Button Hide on Single Page', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Hide "Add to Cart" Button of upcoming product on single product page', 'woocommerce-upcoming-products' ),
                    ...
                    array(
                        'title'   => __( '"Add to Cart" Button Hide on Shop Page', 'woocommerce-upcoming-products' ),
                        'desc'    => __( 'Hide "Add to Cart" Button of upcoming product on shop page', 'woocommerce-upcoming-products' ),
                    ...
                    array(
                        'title'  => __( 'Available Date Show on Single Page', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Show available date on single product page view', 'woocommerce-upcoming-products' ),
                    ...
                    array(
                        'title'  => __( 'Available Date Show on Shop Page', 'woocommerce-upcoming-products' ),
                        'desc'   => __( 'Show available date on shop product page view', 'woocommerce-upcoming-products' ),
